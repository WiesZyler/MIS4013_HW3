...
<div style="Width:500px; margin-top 100px;">
    ...
    labels: [
      ...
      <div style="margin-top:4000px;"></div>
       <p style="font-weight:bold;">Uh Oh, looks like you're on the bottom floor!</p>
      <p style="font-weight:bold;">Just press that up arrow to take the elevator back up!</p>
      <p style="font-weight:bold;">Oh, and remember to have your volume up to hear that classic music!</p>
      <div id="elevator" class="elevator-button btn" style="margin-right:auto; margin-left:auto; display:flex; align-itmes:center; justify-content:center;">
